  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      function handleCancel() {
        ...
        const { key, dataIndex } = column;
        // 回退值
        record[(dataIndex || key) as string] = defaultValueRef.value;
...
<style lang="less">
  ...
  .edit-cell-align-center {
    ...
    input:not(.ant-calendar-picker-input, .ant-time-picker-input, .ant-input-number-input) {
      text-align: center;
    }
  }
  ...
  .@{prefix-cls} {
    ...
    &__normal {
      &-icon {
        ...
        border-radius: 2px;
        background-color: rgb(239 247 255 / 74%);
        cursor: pointer;
      }
    }
